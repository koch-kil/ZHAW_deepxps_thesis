...
X-ray photoelectron spectroscopy (XPS) is a spectroscopic technique and is one of the surface analysis techniques. It is based on the fundamental principle of the photoelectric effect first described by Einstein \cite{einstein_uber_1905} in 1905. 
...
% xps comes to its limits for complex (multi-elemental) samples and xp-spectra contain more information than usually extracted.
...
We formulate tasks to be investigated in this work using a variety of deep learning models.
\begin{enumerate}
